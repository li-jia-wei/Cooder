package com.cooder.core.util.file;
...
public final class FileUtil {
	...
	private static void refreshDCIM() {
		...
		MediaScannerConnection.scanFile(Cooder.getApplicationContext(),
	...
	public static void setIconFont(String path, TextView textView) {
		final Typeface typeface = Typeface.createFromAsset(Cooder.getApplicationContext().getAssets(), path);
	...
	public static String getAssetsFile(String name) {
		...
		final AssetManager assetManager = Cooder.getApplicationContext().getAssets();
		try {
